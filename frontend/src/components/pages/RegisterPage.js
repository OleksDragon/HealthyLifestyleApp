  ...
  return (
    <div className="form-content">
      <input
        className="input"
        style={{
          color: emailCorrect ? "white" : "red",
          border: emailCorrect ? "" : "2px solid red",
        }}
        type="email"
        placeholder="e-mail"
        value={email}
      ...
      <div style={{ position: "relative", width: "100%" }}>
        <input
          ...
          style={{
            color: passwordCorrect ? "white" : "red",
            border: passwordCorrect ? "" : "2px solid red",
          }}
          value={password}
          onChange={(e) => {
      ...
      <div style={{ position: "relative", width: "100%" }}>
        <input
          ...
          placeholder={t("password")}
          style={{
            color: confirmPassword === password ? "white" : "red",
            border: confirmPassword === password ? "" : "2px solid red",
          }}
...
function Form3({ t }) {
  ...
  return (
    <div className="form-content">
      ...
      <br />
      <button className="continue" onClick={() => navigate("/login")}>
        {t("start")}
      </button>
    </div>
  );
  ...
  return (
    <div className="bg">
      ...
      <div
        className="glass"
        style={{
          height: activeForm !== 3 ? "520px" : "300px",
