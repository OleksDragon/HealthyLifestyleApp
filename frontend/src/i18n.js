    ...
    resources: {
      en: {
        translation: {
          ...
          sp_facebook_placeholder: "Enter Facebook username",
      ...
      uk: {
        translation: {
          ...
          sp_facebook_placeholder: "Введіть ім'я користувача Facebook",
      ...
      de: {
        translation: {
          ...
          sp_facebook_placeholder: "Facebook-Benutzername eingeben",
      ...
      fr: {
        translation: {
          ...
          sp_facebook_placeholder: "Entrez le nom d'utilisateur Facebook",
      ...
      es: {
        translation: {
          ...
          sp_facebook_placeholder: "Ingrese el nombre de usuario de Facebook",
