      ...
      <div className="menu-panel">
        ...
        <div className="menu-options">
          ...
          <div className="menu-option" onClick={() => navegate("/health")}>
            <img
              style={{ opacity: window.location.pathname == "/health" ? 1 : 0 }}
              src={healthIcon}
              alt="health"
            />
          ...
          <div className="menu-option" onClick={() => navegate("/eating")}>
            <img
              style={{ opacity: window.location.pathname == "/eating" ? 1 : 0 }}
              src={eatingIcon}
              alt="eating"
            />
          ...
          <div className="menu-option" onClick={() => navegate("/workout")}>
            <img
              style={{
                opacity: window.location.pathname == "/workout" ? 1 : 0,
              }}
              src={workoutIcon}
              alt="workout"
            />
          ...
          <div className="menu-option" onClick={() => navegate("/social")}>
            <img
              style={{
                opacity: window.location.pathname === "/social" ? 1 : 0,
              }}
              src={socialIcon}
              alt="challenges"
            />
          ...
          <div className="menu-option" onClick={() => navegate("/specialists")}>
            <img
              style={{
                opacity: window.location.pathname == "/specialists" ? 1 : 0,
              }}
              src={socialIcon}
              alt="specialists"
            />
          ...
          <div className="menu-option" onClick={() => navegate("/marketplace")}>
            <img
              style={{
                opacity: window.location.pathname == "/marketplace" ? 1 : 0,
              }}
              src={marketplaceIcon}
              alt="marketplace"
            />
          ...
          <div className="menu-option" onClick={() => navegate("/premium")}>
            <img
              style={{
                opacity: window.location.pathname == "/premium" ? 1 : 0,
              }}
              src={premiumIcon}
              alt="premium"
            />
